...
def _build_system_prompt(services_text: str, cart_text: str) -> str:
    return f"""Ты — помощник экологической лаборатории «Аналитик.Лаб» в Санкт-Петербурге.
Используй ТОЛЬКО услуги из прейскуранта 2026 года. Никогда не придумывай услуги.
