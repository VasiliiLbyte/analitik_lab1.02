...
- **FSM-форма КП** — 9 шагов в формате INN-first с валидацией, автоподтяжкой реквизитов по DaData и предпросмотром
...
│   └── kp_form.py                   # KPForm FSM (9 шагов, INN-first + предпросмотр)
├── keyboards/
...
│   ├── kp_form.py                   # FSM-форма КП: 9 шагов (INN-first) + preview + генерация
...
Бот: Шаг 1/9: Введите ИНН (проверка контрольной суммы)
     Если DaData доступен: предлагает подтянуть реквизиты (название, КПП, адрес)
     Шаг 2/9: Название организации
     Шаг 3/9: КПП
     Шаг 4/9: Юридический адрес
     Шаг 5/9: ФИО контактного лица
     Шаг 6/9: Телефон или email
     Шаг 7/9: Фактическое местоположение отбора проб
     Шаг 8/9: Сроки исследований (или «не требуется»)
     Шаг 9/9: Возврат неиспользованной части проб
...
| 8 | Сроки исследований | Текст до 300 символов (можно «не требуется») |
| 9 | Возврат неиспользованной части проб | «да» / «нет» / комментарий до 300 символов |
